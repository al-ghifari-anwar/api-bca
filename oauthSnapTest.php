...
curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://simulator.api.bca.co.id/openapi/v1.0/access-token/b2b',
...
// $saveToken = mysqli_query($conn, "UPDATE tb_bca_token SET bca_token = '$token', date_token = '$dateToken' WHERE id_bca_token = 1");
