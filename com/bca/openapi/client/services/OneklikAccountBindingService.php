...
require_once dirname(__FILE__) . '/../entity/oneklikaccountbindingresponse/OneklikAccountBindingResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\oneklikaccountbindingresponse\OneklikAccountBindingResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class OneklikAccountBindingService extends BaseService
{
    ...
    {
        $request_path = "/openapi/oneklik/v1.0/registration-account-binding";
        ...
        $objResponse = new OneklikAccountBindingResponse();
