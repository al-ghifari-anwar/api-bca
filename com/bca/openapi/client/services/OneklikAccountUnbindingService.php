...
require_once dirname(__FILE__) . '/../entity/oneklikaccountunbindingresponse/OneklikAccountUnbindingResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\oneklikaccountunbindingresponse\OneklikAccountUnbindingResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class OneklikAccountUnbindingService extends BaseService
{
    ...
    {
        $request_path = "/openapi/oneklik/v1.0/registration-account-unbinding";
        ...
        $objResponse = new OneklikAccountUnbindingResponse();
