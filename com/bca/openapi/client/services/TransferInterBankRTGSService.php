...
require_once dirname(__FILE__) . '/../entity/transferinterbankrtgsresponse/TransferInterBankRTGSResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\transferinterbankrtgsresponse\TransferInterBankRTGSResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class TransferInterBankRTGSService extends BaseService
{
    ...
    public function processTransferInterBankRTGS(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/transfer-rtgs";
        ...
        $objResponse = new TransferInterBankRTGSResponse();
