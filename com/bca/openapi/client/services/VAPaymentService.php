...
require_once dirname(__FILE__) . '/../entity/vapaymentresponse/VAPaymentResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\vapaymentresponse\VAPaymentResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class VAPaymentService extends BaseService
{
    ...
    public function getVaPayment(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/transfer-va/payment-intrabank";
        ...
        $objResponse = new VAPaymentResponse();
