...
require_once dirname(__FILE__) . '/../entity/oneklikaccountbindinginquiryresponse/OneklikAccountBindingInquiryResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\oneklikaccountbindinginquiryresponse\OneklikAccountBindingInquiryResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class OneklikAccountBindingInquiryService extends BaseService
{
    ...
    public function accountBindingInquiry(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/oneklik/v1.0/registration-account-inquiry";
        ...
        $objResponse = new OneklikAccountBindingInquiryResponse();
