...
require_once dirname(__FILE__) . '/../entity/transferinterbankonlresponse/TransferInterBankONLResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\transferinterbankonlresponse\TransferInterBankONLResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class TransferInterBankONLService extends BaseService
{
    ...
    public function processTransferInterBankONL(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/transfer-interbank";
        ...
        $objResponse = new TransferInterBankONLResponse();
