...
require_once dirname(__FILE__) . '/../entity/tolakankusknresponse/TolakanKUSKNResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\tolakankusknresponse\TolakanKUSKNResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class TolakanKUSKNService extends BaseService
{
    ...
    public function tolakanKUSKN(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/transfer-skn/notify";
        ...
        $objResponse = new TolakanKUSKNResponse();
