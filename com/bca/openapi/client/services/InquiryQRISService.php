...
require_once dirname(__FILE__) . '/../entity/inquiryqrisresponse/InquiryQRISResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\inquiryqrisresponse\InquiryQRISResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class InquiryQRISService extends BaseService
{
    ...
    {
        $request_path = "/openapi/v1.0/qr/qr-mpm-query";
        ...
        $objResponse = new InquiryQRISResponse();
