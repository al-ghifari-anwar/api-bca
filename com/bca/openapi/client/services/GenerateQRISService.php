...
require_once dirname(__FILE__) . '/../entity/generateqrisresponse/GenerateQRISResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\generateqrisresponse\GenerateQRISResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class GenerateQRISService extends BaseService
{
    ...
    {
        $request_path = "/openapi/v1.0/qr/qr-mpm-generate";
        ...
        $objResponse = new GenerateQRISResponse();
