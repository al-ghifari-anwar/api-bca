...
require_once dirname(__FILE__) . '/../entity/internalaccountinquiryresponse/InternalAccountInquiryResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\internalaccountinquiryresponse\InternalAccountInquiryResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class InternalAccountInquiryService extends BaseService
{
    ...
    public function getInternalAccountInquiry(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/account-inquiry-internal";
        ...
        $objResponse = new InternalAccountInquiryResponse();
