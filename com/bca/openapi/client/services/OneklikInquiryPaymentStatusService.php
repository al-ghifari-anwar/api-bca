...
require_once dirname(__FILE__) . '/../entity/oneklikinquirypaymentstatusresponse/OneklikInquiryPaymentStatusResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\oneklikinquirypaymentstatusresponse\OneklikInquiryPaymentStatusResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class OneklikInquiryPaymentStatusService extends BaseService
{
    ...
    {
        $request_path = "/openapi/oneklik/v1.0/debit/status";
        ...
        $objResponse = new OneklikInquiryPaymentStatusResponse();
