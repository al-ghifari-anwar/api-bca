...
require_once dirname(__FILE__) . '/../entity/vabillpresentmentresponse/VABillPresentmentResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\vabillpresentmentresponse\VABillPresentmentResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class VABillPresentmentService extends BaseService
{
    ...
    public function getInquiryBillPresentment(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/transfer-va/inquiry-intrabank";
        ...
        $objResponse = new VABillPresentmentResponse();
