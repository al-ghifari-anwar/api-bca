...
require_once dirname(__FILE__) . '/../entity/tolakankurtgsresponse/TolakanKURTGSResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\tolakankurtgsresponse\TolakanKURTGSResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class TolakanKURTGSService extends BaseService
{
    ...
    public function tolakanKURTGS(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/transfer-rtgs/notify";
        ...
        $objResponse = new TolakanKURTGSResponse();
