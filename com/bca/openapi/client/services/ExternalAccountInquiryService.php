...
require_once dirname(__FILE__) . '/../entity/externalaccountinquiryresponse/ExternalAccountInquiryResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\externalaccountinquiryresponse\ExternalAccountInquiryResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class ExternalAccountInquiryService extends BaseService
{
    ...
    public function getExternalAccountInquiry(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/account-inquiry-external";
        ...
        $objResponse = new ExternalAccountInquiryResponse();
