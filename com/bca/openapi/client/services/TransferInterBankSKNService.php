...
require_once dirname(__FILE__) . '/../entity/transferinterbanksknresponse/TransferInterBankSKNResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\transferinterbanksknresponse\TransferInterBankSKNResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class TransferInterBankSKNService extends BaseService
{
    ...
    public function processTransferInterBankSKN(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/transfer-skn";
        ...
        $objResponse = new TransferInterBankSKNResponse();
