...
require_once dirname(__FILE__) . '/../entity/vapaymentstatusresponse/VAPaymentStatusResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\vapaymentstatusresponse\VAPaymentStatusResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class VAPaymentStatusService extends BaseService
{
    ...
    public function getVaPaymentStatus(
        $external_id,
        $request
    )
    {
        ...
        $objResponse = new VAPaymentStatusResponse();
