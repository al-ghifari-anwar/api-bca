...
require_once dirname(__FILE__) . '/../entity/oneklikinquiryphonenumberotpresponse/OneklikInquiryPhoneNumberOTPResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\oneklikinquiryphonenumberotpresponse\OneklikInquiryPhoneNumberOTPResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class OneklikInquiryPhoneNumberOTPService extends BaseService
{
    ...
    public function inquiryOTP(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/oneklik/v1.0/payment/inquiry-phone-number";
        ...
        $objResponse = new OneklikInquiryPhoneNumberOTPResponse();
