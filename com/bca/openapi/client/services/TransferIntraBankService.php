...
require_once dirname(__FILE__) . '/../entity/transferintrabankresponse/TransferIntraBankResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\transferintrabankresponse\TransferIntraBankResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class TransferIntraBankService extends BaseService
{
    ...
    public function processTransferIntraBank(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/transfer-intrabank";
        ...
        $objResponse = new TransferIntraBankResponse();
