...
require_once dirname(__FILE__) . '/../entity/transferstatusresponse/TransferStatusResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\transferstatusresponse\TransferStatusResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class TransferStatusService extends BaseService
{
    ...
    {
        $request_path = "/openapi/v1.0/transfer/status";
        ...
        $objResponse = new TransferStatusResponse();
