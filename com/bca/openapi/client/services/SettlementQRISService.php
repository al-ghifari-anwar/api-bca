...
require_once dirname(__FILE__) . '/../entity/settlementqrisresponse/SettlementQRISResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\settlementqrisresponse\SettlementQRISResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class SettlementQRISService extends BaseService
{
    ...
    public function settlementQRIS(
        $external_id,
        $request
    )
    {
        $request_path = "/openapi/v1.0/qr/qr-mpm-settlement";
        ...
        $objResponse = new SettlementQRISResponse();
