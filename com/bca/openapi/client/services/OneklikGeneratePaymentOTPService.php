...
require_once dirname(__FILE__) . '/../entity/oneklikgeneratepaymentotpresponse/OneklikGeneratePaymentOTPResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\oneklikgeneratepaymentotpresponse\OneklikGeneratePaymentOTPResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class OneklikGeneratePaymentOTPService extends BaseService
{
    ...
    {
        $request_path = "/openapi/oneklik/v1.0/otp";
        ...
        $objResponse = new OneklikGeneratePaymentOTPResponse();
