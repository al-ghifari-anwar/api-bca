...
require_once dirname(__FILE__) . '/../entity/accountstatementresponse/AccountStatementResponse.php';

use com\bca\openapi\client\service\BaseService;
use com\bca\openapi\client\entity\accountstatementresponse\AccountStatementResponse;
use com\bca\openapi\client\utils\JsonMapper;
use Unirest\Request;
use Unirest\Request\Body;
class AccountStatementService extends BaseService
{
    ...
    {
        $request_path = "/openapi/v1.0/bank-statement";
        ...
        $objResponse = new AccountStatementResponse();
